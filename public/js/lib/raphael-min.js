...
function cq(a,b){
    ...
    if(a){
        for(var e in a)a[g](e)&&(d[Q(e)]=a[e],c.push(Q(e)));c.sort(bc)
        }
...
var cl=[],cm=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){
    ...
    for(;c<cl.length;c++){
        ...
        if(d.repeat>1&&!d.next){
            for(s in k)k[g](s)&&(r[s]=d.totalOrigin[s]);d.el.attr(r),cr(d.anim,d.el,d.anim.percents[0],null,d.totalOrigin,d.repeat-1)
            }
...
b$.animateWith=function(b,c,d,e,f,g){
    ...
    b=Object(b),c=+c||0;
    var f={},h,i;
    for(i in b)b[g](i)&&Q(i)!=i&&Q(i)+"%"!=i&&(h=!0,f[i]=b[i]);if(!h)return new cq(b,c);
...
return b
    ...
    for(var n in m)k("attr."+n+"."+this.id,this,m[n]);for(n in this.paper.customAttributes)if(this.paper.customAttributes[b](n)&&m[b](n)&&a.is(this.paper.customAttributes[n],"function")){
...
D.prototype=E,E.constructor=D,E.transform=function(b){
    ...
    for(var o in n)l("attr."+o+"."+this.id,this,n[o]);if(n){
